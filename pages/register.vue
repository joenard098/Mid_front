        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 offset-md-4 mt-3">
                    <b-card header="Register" style="font-weight: bold;">
                        <form action="#" @submit.prevent="onRegister">
                            ...
                            <p>Already have an account? Click <b-link href="/login">Login</b-link></p>
                        </form>
                    </b-card>
                </div>
            </div>
...
export default {
    ...
    methods: {
        async onRegister() {
            this.$axios.post('https://lentrix.tk/lmd/api/register', this.user)
            .then((res)=>{
                if(res.status==202) {
